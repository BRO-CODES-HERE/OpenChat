...
function detectAndSetupDownload() {
    ...
    let downloadPath = "https://github.com/BRO-CODES-HERE/OpenChat/releases/download/v1.1.2/OpenChat-Win.exe";
    let iconClass = "fa-brands fa-windows";

    if (platform.indexOf("Win") !== -1) {
        detectedOS = "Windows (.exe)";
        downloadPath = "https://github.com/BRO-CODES-HERE/OpenChat/releases/download/v1.1.2/OpenChat-Win.exe";
        ...
        downloadPath = "https://github.com/BRO-CODES-HERE/OpenChat/releases/download/v1.1.2/OpenChat-Mac.zip";
        iconClass = "fa-brands fa-apple";
    } else if (platform.indexOf("Linux") !== -1 || userAgent.indexOf("Linux") !== -1) {
        detectedOS = "Linux (Binary)";
        downloadPath = "https://github.com/BRO-CODES-HERE/OpenChat/releases/download/v1.1.2/OpenChat-linux";
